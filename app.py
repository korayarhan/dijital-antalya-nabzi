...
from src.config import (
    ...
    SOCIAL_AUTO_CSV,
    AUTO_SOCIAL_CSV,
    PRESIDENT_X_POSTS_CSV,
    PRESIDENT_X_REPLIES_CSV,
    X_API_HEALTH_CSV,
    YOUTUBE_SOCIAL_CSV,
    YOUTUBE_SUMMARY_CSV,
    INSTAGRAM_SOCIAL_CSV,
    ACCOUNTS_MAP_CSV,
    ...
    TEAM_ACTIONS_CSV,
    ARCHIVE_DIR,
    DAILY_DECISION_LOG_CSV,
    DEMO_DIR,
    DEMO_SOCIAL_ACCOUNTS_CSV,
    DAILY_REPORT_HTML,
    TEAM_REPORT_HTML,
    CRISIS_PANEL_HTML,
    VERSION_JSON,
...
def read_keywords():
    ...
    dynamic = read_keyword_file(DYNAMIC_KEYWORDS_FILE)
    combined, seen = [], set()
...
"""
    ...
    for item in risky_social:
        ...
        <div class="card" style="border-left: 5px solid {badge_color}; margin: 14px 0;">
            ...
            <p style="margin:8px 0;"><b>Aksiyon notu:</b> {esc(item.get("action_note", "") or item.get("notes", "") or item.get("risk_note", "") or "Ekip tarafından gözle kontrol edilmeli.")}
...
">
    ...
    ">
        <div style="
            ...
            opacity:1 !important;
        ">
            <div style="color:#f8fafc !important;opacity:1 !important;">
                <div style="
                    color:#f8fafc !important;
                    font-size:20px;
                    font-weight:950;
